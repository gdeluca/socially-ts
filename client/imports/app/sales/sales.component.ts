...
export class SalesComponent {
  ...
  headers: Dictionary[] = [
    {'key': 'Nº Venta', 'value':'saleNumber', 'showHeader': false},
    {'key': 'Forma de Pago', 'value': 'payment', 'showHeader': true},
    {'key': 'Descuento', 'value':'discount', 'showHeader': false},
    {'key': 'Estado de Venta', 'value':'status', 'showHeader': true},
    {'key': 'Fecha de Venta', 'value':'saleDate', 'showHeader': true},
    {'key': 'Ultimo Cambio', 'value':'lastUpdate', 'showHeader': false},
    {'key': 'Vendedor', 'value':'seller', 'showHeader': true},
    {'key': 'Sucursal', 'value':'name', 'showHeader': true},
    {'key': 'Total', 'value':'total', 'showHeader': false},
  ];
